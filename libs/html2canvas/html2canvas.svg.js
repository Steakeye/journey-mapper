...
(function(){
   ...
   * @alias on
   * @param {String|Object} eventName Event name (eg. 'after:render') or object with key/value pairs (eg.
   *   {'after:render': handler, 'selection:cleared': handler})
...
(function(global) {
   ...
   * @param {Function} callback Callback to call when parsing is finished; It's being passed an array of elements
  ...
  extend(fabric, {
    ...
    /**
     * Takes url corresponding to an SVG document, and parses it into a set of fabric objects. Note that SVG is fetched
     * via XMLHttpRequest, so it needs to conform to SOP (Same Origin Policy)
     * @memberof fabric
     * @param {String} url
     * @param {Function} callback
     * @param {Function} [reviver] Method for further parsing of SVG elements, called after each fabric object created.
...
(function(global) {
  ...
  fabric.Color.prototype = /** @lends fabric.Color.prototype */ {
    ...
    /**
     * Adapted from <a
     * href="https://rawgithub.com/mjijackson/mjijackson.github.com/master/2008/02/rgb-to-hsl-and-rgb-to-hsv-color-model-conversion-algorithms-in-javascript.html">https://github.com/mjijackson</a>
     * @private
  ...
  /**
   * Regex matching color in RGB or RGBA formats (ex: rgb(0, 0, 0), rgba(255, 100, 10, 0.5), rgba( 255 , 100 , 10 , 0.5
  ...
  /**
   * Regex matching color in HSL or HSLA formats (ex: hsl(200, 80%, 10%), hsla(300, 50%, 80%, 0.5), hsla( 300 , 50% ,
   * 80% , 0.5 ))
   * @static
   * @field
   * @memberOf fabric.Color
...
(function(global) {
  ...
  fabric.Shadow = fabric.util.createClass(/** @lends fabric.Shadow.prototype */ {
    ...
    /**
     * Constructor
     * @param {Object|String} [options] Options object with any of color, blur, offsetX, offsetX properties or string
     *   (e.g. "rgba(0,0,0,0.2) 2px 2px 10px, "2px 2px 10px rgba(0,0,0,0.2)")
...
(function () {
  ...
  fabric.StaticCanvas = fabric.util.createClass(/** @lends fabric.StaticCanvas.prototype */ {
    ...
    /**
     * Indicates whether {@link fabric.Collection.add}, {@link fabric.Collection.insertAt} and {@link
     * fabric.Collection.remove} should also re-render canvas. Disabling this option could give a great performance
     * boost when adding/removing a lot of objects to/from canvas at once
     ...
     * @private
     * @see {@link
     *   http://www.whatwg.org/specs/web-apps/current-work/multipage/the-canvas-element.html#dom-context-2d-imagesmoothingenabled|WhatWG
     *   Canvas Standard}
     */
     ...
     * @param {(fabric.Image|String|null)} image fabric.Image instance, URL of an image or null to set background or
     *   overlay to
    ...
    /**
     * Sets dimensions (width, height) of this canvas instance. when options.cssOnly flag active you should also supply
     * the unit of measure (px/%/em)
     * @param {Object}        dimensions                    Object with width/height properties
     * @param {Number|String} [dimensions.width]            Width of canvas element
     * @param {Number|String} [dimensions.height]           Height of canvas element
     * @param {Object}        [options]                     Options object
     * @param {Boolean}       [options.backstoreOnly=false] Set the given dimensions only as canvas backstore
     *   dimensions
     * @param {Boolean}       [options.cssOnly=false]       Set the given dimensions only as css dimensions
     * @return {fabric.Canvas} thisArg
     * @chainable
     ...
     * @param {Function} [reviver] Method for further parsing of svg elements, called after each fabric object
     *   converted into svg representation.
...
fabric.util.object.extend(fabric.StaticCanvas.prototype, /** @lends fabric.StaticCanvas.prototype */ {
   ...
   * @return {String} Returns a data: URL containing a representation of the object in the format specified by
   *   options.format
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
    ...
    /**
     * Top position of an object. Note that by default it's relative to object center. You can change this by setting
    ...
    /**
     * Left position of an object. Note that by default it's relative to object center. You can change this by setting
    ...
    /**
     * When set to `false`, an object can not be selected for modification (using either point-click-based or
     * group-based selection). But events still fire on it.
     * @type Boolean
     * @default
     */
    selectable:               true,
    ...
    /**
     * When set to `false`, an object can not be a target of events. All events propagate through it. Introduced in
     * v1.3.4
     * @type Boolean
     * @default
     */
     ...
     * @param {CanvasRenderingContext2D} ctx Context
     * @param {Boolean} fromLeft When true, context is transformed to object's top/left corner. This is used when
     *   rendering text on Node
     */
    ...
    /**
     * Sets property to a given value. When changing position/dimension -related properties (left, top, scale, angle,
     * etc.) `set` does not update position of object's borders/controls. If you need to update those, call
     * `setCoords()`.
     * @param {String|Object} key Property name or object (if object, iterate over the object properties)
     * @param {Object|Function} value Property value (if function, the value is passed into it and its return value is
     *   used as a new one)
     * @return {fabric.Object} thisArg
     * @chainable
     */
     ...
     * @param {String} [options.repeat=repeat] Repeat property of a pattern (one of repeat, repeat-x, repeat-y or
     *   no-repeat)
...
(function(global) {
  ...
  fabric.Rect = fabric.util.createClass(fabric.Object, /** @lends fabric.Rect.prototype */ {
    ...
    /**
     * List of properties to consider when checking if state of an object is changed ({@link
     * fabric.Object#hasStateChanged}) as well as for history (undo/redo) purposes
     * @type Array
     */
...
(function(global) {
  ...
  fabric.Image = fabric.util.createClass(fabric.Object, /** @lends fabric.Image.prototype */ {
     ...
     * You might need to call `canvas.renderAll` and `object.setCoords` after replacing, to render new image and update
     * controls area.
   ...
   * @param {Function} [callback] Callback to invoke when image is created (newly created image is passed as a first
   *   argument)
...
(function(global) {
   ...
   * Adapted from <a
   * href="http://www.laurenscorijn.com/articles/colormath-basics">http://www.laurenscorijn.com/articles/colormath-basics</a>
