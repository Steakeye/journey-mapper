...
{
	var value = Number(document.getElementById("animDelay").value/1000);
	value.toFixed(2);
...
this.gifalizer = function(paintedCanvases) //function, called from DOM to build gif.
{
	...
	var imageItems = []; //hacky way to ensure that an arbitrary number of onload events occur.
